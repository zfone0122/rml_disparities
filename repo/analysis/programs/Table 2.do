...
*description: Differential Effect of RMLs on Adult Marijuana 
*             Arrests, by Race
**********************************************************
clear all 
...
**log arrest rate 
gen ln_rate_total_cannabis_1899=ln(rate_total_cannabis_1899)
gen ln_rate_poss_cannabis_1899=ln(rate_poss_cannabis_1899)
gen ln_rate_sale_cannabis_1899=ln(rate_sale_cannabis_1899)

**arrest ratio 
gen total_cannabis_ratio=total_cannabis_1899/total_1899
gen poss_cannabis_ratio=poss_cannabis_1899/total_1899
gen sale_cannabis_ratio=sale_cannabis_1899/total_1899
...
***Panel I: Arrest Rate
*c1
reghdfe rate_total_cannabis_1899 $sat_interx rml rml_black [pw=pop_1899], a(i.fips#i.black i.year#i.black) vce(cl fips)
...
*c2
reghdfe rate_poss_cannabis_1899 $sat_interx rml rml_black [pw=pop_1899], a(i.fips#i.black i.year#i.black) vce(cl fips)
	sum rate_poss_cannabis_1899 [aw=pop_1899] if rml==0 & ever_rml==1 & race==2
	estadd scalar pdvm_b = r(mean)
	sum rate_poss_cannabis_1899 [aw=pop_1899] if rml==0 & ever_rml==1 & race==3
	estadd scalar pdvm_w = r(mean)	
	est store c2	
		
*c3
reghdfe rate_sale_cannabis_1899 $sat_interx rml rml_black [pw=pop_1899], a(i.fips#i.black i.year#i.black) vce(cl fips)
	sum rate_sale_cannabis_1899 [aw=pop_1899] if rml==0 & ever_rml==1 & race==2
	estadd scalar pdvm_b = r(mean)
	sum rate_sale_cannabis_1899 [aw=pop_1899] if rml==0 & ever_rml==1 & race==3
	estadd scalar pdvm_w = r(mean)	
	est store c3		

esttab c1 c2 c3 using "Table 2.csv", label ///
	title("Table 2")  ///
	keep(rml rml_black) ///
	...
	mtitles("All Marijuana Arrests" "Marijuana Possession Arrests" "Marijuana Sales Arrests") nogaps se nonotes ///
	page replace 
	est clear 		
	
***Panel II: Log Arrest Rate
*c1
reghdfe ln_rate_total_cannabis_1899 $sat_interx rml rml_black [pw=pop_1899], a(i.fips#i.black i.year#i.black) vce(cl fips)
	sum rate_total_cannabis_1899 [aw=pop_1899] if rml==0 & ever_rml==1 & race==2
	estadd scalar pdvm_b = r(mean)
	sum rate_total_cannabis_1899 [aw=pop_1899] if rml==0 & ever_rml==1 & race==3
	estadd scalar pdvm_w = r(mean)	
...
*c2
reghdfe ln_rate_poss_cannabis_1899 $sat_interx rml rml_black [pw=pop_1899], a(i.fips#i.black i.year#i.black) vce(cl fips)
	sum rate_poss_cannabis_1899 [aw=pop_1899] if rml==0 & ever_rml==1 & race==2
	estadd scalar pdvm_b = r(mean)
	sum rate_poss_cannabis_1899 [aw=pop_1899] if rml==0 & ever_rml==1 & race==3
	estadd scalar pdvm_w = r(mean)	
...
*c3
reghdfe ln_rate_sale_cannabis_1899 $sat_interx rml rml_black [pw=pop_1899], a(i.fips#i.black i.year#i.black) vce(cl fips)
	sum rate_sale_cannabis_1899 [aw=pop_1899] if rml==0 & ever_rml==1 & race==2
	estadd scalar pdvm_b = r(mean)
	sum rate_sale_cannabis_1899 [aw=pop_1899] if rml==0 & ever_rml==1 & race==3
	estadd scalar pdvm_w = r(mean)	
