...
*description: Border RML estimates
**********************************************************
clear all 
...
merge m:1 fips year using `rml_border'
drop if _merge==2
drop _merge 
...
esttab c1 c2 c3 c4 c5 c6 c7 c8 using "Table 7.csv", label ///
		title("Table 7 - Panel 1 ")  ///
		keep(rml) ///
