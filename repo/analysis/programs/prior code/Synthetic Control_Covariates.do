**********************************************************
*name: Synthetic Control_Covariates.do
*author: Zach Fone (U.S. Air Force Academy)
*description: Matching on covariates
*created: december 10, 2022
*updated: NA
**********************************************************
clear 

cd "$path\analysis\figures\synth\covariates\"
...
synth rate_total_cannabis_1899 pc_income unemployment eitc , trunit(8) trperiod(2013) resultsperiod(2000(1)2019) nest fig 
...
********
synth_runner rate_total_cannabis_1899 pc_income unemployment eitc , trunit(8) trperiod(2013) gen_vars 
ereturn list
...
synth rate_total_cannabis_1899 pc_income unemployment eitc , trunit(53) trperiod(2013) resultsperiod(2000(1)2019) nest fig 
...
*using synth_runner to conduct a permutation test
********
synth_runner rate_total_cannabis_1899 pc_income unemployment eitc , trunit(53) trperiod(2013) gen_vars 
ereturn list
di (e(pval_joint_post_std)*e(n_pl)+1)/(e(n_pl)+1) //p-value if truly random || see page 844 from the following url for a walk-through of the p-value calculation: https://journals.sagepub.com/doi/pdf/10.1177/1536867X1801700404
*single_treatment_graphs
gen p_val=(e(pval_joint_post_std)*e(n_pl)+1)/(e(n_pl)+1)
...
synth rate_total_cannabis_1899 pc_income unemployment eitc , trunit(2) trperiod(2015) resultsperiod(2000(1)2019) nest fig 
...
*using synth_runner to conduct a permutation test
********
synth_runner rate_total_cannabis_1899 pc_income unemployment eitc , trunit(2) trperiod(2015) gen_vars 
ereturn list
di (e(pval_joint_post_std)*e(n_pl)+1)/(e(n_pl)+1) //p-value if truly random || see page 844 from the following url for a walk-through of the p-value calculation: https://journals.sagepub.com/doi/pdf/10.1177/1536867X1801700404
*single_treatment_graphs
gen p_val=(e(pval_joint_post_std)*e(n_pl)+1)/(e(n_pl)+1)
...
synth rate_total_cannabis_1899 pc_income unemployment eitc , trunit(41) trperiod(2015) resultsperiod(2000(1)2019) nest fig 
...
*using synth_runner to conduct a permutation test
********
synth_runner rate_total_cannabis_1899 pc_income unemployment eitc , trunit(41) trperiod(2015) gen_vars 
ereturn list
di (e(pval_joint_post_std)*e(n_pl)+1)/(e(n_pl)+1) //p-value if truly random || see page 844 from the following url for a walk-through of the p-value calculation: https://journals.sagepub.com/doi/pdf/10.1177/1536867X1801700404
*single_treatment_graphs
gen p_val=(e(pval_joint_post_std)*e(n_pl)+1)/(e(n_pl)+1)
...
synth rate_total_cannabis_1899 pc_income unemployment eitc , trunit(6) trperiod(2017) resultsperiod(2000(1)2019) nest fig 
...
*using synth_runner to conduct a permutation test
********
synth_runner rate_total_cannabis_1899 pc_income unemployment eitc , trunit(6) trperiod(2017) gen_vars 
ereturn list
di (e(pval_joint_post_std)*e(n_pl)+1)/(e(n_pl)+1) //p-value if truly random || see page 844 from the following url for a walk-through of the p-value calculation: https://journals.sagepub.com/doi/pdf/10.1177/1536867X1801700404
*single_treatment_graphs
gen p_val=(e(pval_joint_post_std)*e(n_pl)+1)/(e(n_pl)+1)
...
synth rate_total_cannabis_1899 pc_income unemployment eitc , trunit(25) trperiod(2017) resultsperiod(2000(1)2019) nest fig 
...
*using synth_runner to conduct a permutation test
********
synth_runner rate_total_cannabis_1899 pc_income unemployment eitc , trunit(25) trperiod(2017) gen_vars 
ereturn list
di (e(pval_joint_post_std)*e(n_pl)+1)/(e(n_pl)+1) //p-value if truly random || see page 844 from the following url for a walk-through of the p-value calculation: https://journals.sagepub.com/doi/pdf/10.1177/1536867X1801700404
*single_treatment_graphs
gen p_val=(e(pval_joint_post_std)*e(n_pl)+1)/(e(n_pl)+1)
