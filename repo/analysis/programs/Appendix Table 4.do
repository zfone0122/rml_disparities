...
esttab c1 c2 c3 c4 using "Appendix Table 4.csv", label ///
	title("Appendix Table 4 - Panel 1 - Agency level")  ///
	keep(rml rml_black) ///
...
esttab c1 c2 c3 c4 using "Appendix Table 4.csv", label ///
	title("Appendix Table 4 - Panel 2 - Poisson [unweighted; agency-year]")  ///
	keep(rml rml_black) ///
...
***Panel III: Unweighted [state-year]
use `state', clear
*c1
...
esttab c1 c2 c3 c4 using "Appendix Table 4.csv", label ///
	title("Appendix Table 4 - Panel 3 - Unweighted")  ///
	keep(rml rml_black) ///
	noobs scalars("pdvm_w Pre-treat DV mean (White)" "pdvm_b Pre-treat DV mean (Black)" "N N") bfmt(2) sefmt(2) sfmt(2 2 0) star(* 0.10 ** 0.05 *** 0.01) ///
	mtitles("Marijuana" "Non-Marijuana" "Property" "Violent") nogaps se nonotes ///
	page append 
