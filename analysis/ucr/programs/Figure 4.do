...
*description: Event-Study Analyses of RMLs and Property and Violent Crime Arrests,
*             TWFE Estimates
**********************************************************
...
**Panel A: Property Arrests 
	...
	*c1 - black 
	...
	yline(0, lcolor(gs8)) ylabel(-450(150)450,labsize(small)) legend(pos(6) col(2))
	graph export "Figure 4_prop.png", replace     
	est clear 
...
**Panel B: Violent Arrests 
	...
	*c1 - black 
	...
	graph export "Figure 4_viol.png", replace     
	est clear 		
