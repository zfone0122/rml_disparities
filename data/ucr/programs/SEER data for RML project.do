...
infix year 1-4 str state 5-6 stfips 7-8 countyfips 9-11 registry 12-13 race 14 origin 15 sex 16 age 17-18 population 19-26 using "$path\data\ucr\data\seer\raw\us.1969_2020.singleages.adjusted.txt"
...
gcollapse (sum) totalpop pop_*, by(stfips year)
ren stfips fips 
keep if inrange(fips, 1, 56)

*save 
save "$path\data\ucr\data\seer\cleaned\seer_state-year_2000-2019_cleaned.dta", replace 
...
*save 
save "$path\data\ucr\data\seer\cleaned\seer_county-year_2000-2019_cleaned.dta", replace 
